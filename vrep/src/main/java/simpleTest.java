...
public class simpleTest
{
	public static void main(String[] args)
	{
		...
		//System.setProperty("java.library.path", "C:\\Users\\Jan\\Documents\\NetBeansProjects\\Project1950\\vrep\\src\\main\\java");
		...
		if (clientID!=-1)
		{
			...
			//vrep.simxGetIntegerParameter(clientID,vrep.sim_intparam_,mouseX,vrep.simx_opmode_streaming); // Initialize streaming
